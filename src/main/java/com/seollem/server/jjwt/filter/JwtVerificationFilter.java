...
//import com.seollem.server.jjwt.TokenService;
...
//        String accessToken = tokenService.delegateAccessToken(request);
//        String refreshToken = tokenService.delegateRefreshToken(request);
...
//        if(accessToken != null){
    ...
    private void setAuthenticationToContext(Map<String, Object> claims) {
        ...
        List<GrantedAuthority> authorities = roleAuthorityUtils.createAuthorities((List)claims.get("roles"));
