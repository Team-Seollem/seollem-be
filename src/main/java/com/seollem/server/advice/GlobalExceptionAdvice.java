package com.seollem.server.advice;
...
public class GlobalExceptionAdvice {
  ...
  public ErrorResponse handleHttpRequestMethodNotSupportedException(
    ...
    final ErrorResponse response =
        ErrorResponse.of(HttpStatus.METHOD_NOT_ALLOWED, "request body 가 없습니다.");
  ...
  public ErrorResponse handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
    ...
    final ErrorResponse response =
        ErrorResponse.of(HttpStatus.BAD_REQUEST, "Required request body is missing");
  ...
  public ErrorResponse handleException(Exception e) {
    ...
    final ErrorResponse response =
        ErrorResponse.of(
            HttpStatus.INTERNAL_SERVER_ERROR, "Required request body is missing");
